...
namespace MyCalculator
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        public static readonly string[] ERROR_MESSAGES = { string.Empty, "Нельзя делить на ноль", "Не определенное число", "Переполнение", "Недополнение", "Неправильный ввод" };
        ...
        private void XButtonNumber_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (double.TryParse(tempStringValue, out double parsedDouble))
            {
        ...
        private void XButtonDelete_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                if (double.TryParse(DisplayedValue, out double parsedDouble))
                {
                    mOperand.DomainValue = parsedDouble;
                    mOperand.FinalValue = mOperand.DomainValue;
                }
